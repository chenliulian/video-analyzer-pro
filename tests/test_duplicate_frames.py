...
def calculate_frame_similarity_current(frame1, frame2):
    """当前使用的相似度算法"""
...
problem_frames = [
    f"{frames_folder}/frame_0012_34.00s.jpg",
    f"{frames_folder}/frame_0013_37.00s.jpg",
    f"{frames_folder}/frame_0014_40.00s.jpg",
    f"{frames_folder}/frame_0015_43.00s.jpg",
    f"{frames_folder}/frame_0016_46.00s.jpg",
    f"{frames_folder}/frame_0017_49.00s.jpg",
]

print("=" * 80)
print("测试第13-18页的图片相似度")
print("=" * 80)
...
for i in range(len(images) - 1):
    ...
    combined, hist_diff, edge_diff, brightness_diff = calculate_frame_similarity_current(img1, img2)
    ...
    print(f"  判断: {'不同场景' if combined >= 30 else '相似/重复'}")
